...
tf.train.write_graph(sess.graph_def, pb_file_path, 'model_b.pb', as_text = False)
tf.train.write_graph(sess.graph_def, pb_file_path, 'model_t.pb', as_text = True)

#保存模型 -normal
constant_graph = graph_util.convert_variables_to_constants(sess, sess.graph_def, ['prediction'])
with tf.gfile.FastGFile(pb_file_path+'model-nt.pb', mode='wb') as f:
    f.write(constant_graph.SerializeToString())

#with tf.gfile.FastGFile(pb_file_path+'model-nt.pb', mode='wb') as f:
#    f.write(constant_graph)
